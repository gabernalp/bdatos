...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.sedParticipacionArtistum.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sed-participacion-artista.update", [$sedParticipacionArtistum->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nombre_artista">{{ trans('cruds.sedParticipacionArtistum.fields.nombre_artista') }}</label>
                <input class="form-control {{ $errors->has('nombre_artista') ? 'is-invalid' : '' }}" type="text" name="nombre_artista" id="nombre_artista" value="{{ old('nombre_artista', $sedParticipacionArtistum->nombre_artista) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_festival') ? 'is-invalid' : '' }}" type="text" name="nombre_festival" id="nombre_festival" value="{{ old('nombre_festival', $sedParticipacionArtistum->nombre_festival) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_inicial') ? 'is-invalid' : '' }}" type="text" name="fecha_inicial" id="fecha_inicial" value="{{ old('fecha_inicial', $sedParticipacionArtistum->fecha_inicial) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final') ? 'is-invalid' : '' }}" type="text" name="fecha_final" id="fecha_final" value="{{ old('fecha_final', $sedParticipacionArtistum->fecha_final) }}">
