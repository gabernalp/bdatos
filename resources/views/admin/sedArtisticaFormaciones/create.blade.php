...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.sedArtisticaFormacione.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sed-artistica-formaciones.store") }}" enctype="multipart/form-data">
            @csrf
