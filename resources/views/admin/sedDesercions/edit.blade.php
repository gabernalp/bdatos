...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.sedDesercion.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sed-desercions.update", [$sedDesercion->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
