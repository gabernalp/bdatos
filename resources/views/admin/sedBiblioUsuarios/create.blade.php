...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.sedBiblioUsuario.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sed-biblio-usuarios.store") }}" enctype="multipart/form-data">
            @csrf
